...
public class MenuTest {
    ...
    public void shouldReturnTheListOfMenuOptionsForGuestUsers() {
        ...
        menuOptions += "Log in\n";
        assertEquals(menuOptions, menu.getMenuOptions(new User("lib-0001", "name", "abc", "abc@gmail.com", new GuestRole())));
    }
    ...
    public void shouldReturnTheListOfMenuOptionsForNormalUsers() {
        ...
        menuOptions += "Log out\n";
        assertEquals(menuOptions, menu.getMenuOptions(new User("lib-0001", "name", "abc", "abc@gmail.com", new LoggedInUserRole())));
    }
    ...
    public void shouldReturnTheListOfMenuOptionsForAdmin() {
        ...
        menuOptions += "Log out\n";
        assertEquals(menuOptions, menu.getMenuOptions(new User("lib-0001", "name", "abc", "abc@gmail.com", new AdminRole())));
    }
